...
public class GpsInfo extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		MySurfaceView glSurfaceView = new MySurfaceView(this);
		...
		addContentView(surfaceView, p);
		addContentView(glSurfaceView, p);
		...
		// frameLayout.addView(textview, new LayoutParams(
